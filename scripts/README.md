...
| `docker_entrypoint.py`         | Click-based successor to `docker_entrypoint.sh` (unhooked parallel implementation — see #526; subcommand dispatch, per-mode `--spec`) | `python scripts/docker_entrypoint.py idle`                                   |
