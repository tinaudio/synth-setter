...
| `scripts/studiorack/`             | Post-install compatibility patches for Linux VST3 bundles and unprivileged archive installs; remove after upstream [#82](https://github.com/open-audio-stack/open-audio-stack-core/issues/82), [#83](https://github.com/open-audio-stack/open-audio-stack-core/issues/83), and [#84](https://github.com/open-audio-stack/open-audio-stack-core/issues/84) ship |
