...
# Subset of `_WORKER_ENV_KEYS` that the launcher must see populated to make
# any meaningful R2/wandb call. The non-secret rclone constants default in
# `_R2_RCLONE_CONSTANTS`, so an "empty" worker_env still has those keys —
# the unconfigured-creds check needs the residual secret subset.
...
DEFAULT_EXPERIMENT = "datagen/runpod-smoke-shard"
