...
class PlotLossPerTimestep(Callback):
    ...
    def _get_val_batch(self, trainer):  # noqa: ANN001
        val_dl = trainer.val_dataloaders
        return next(iter(val_dl))

    def _compute_losses(self, trainer, pl_module):  # noqa: ANN001
    ...
    def _aggregate_losses(self, losses):  # noqa: ANN001
    ...
    def _plot_losses(self, losses):  # noqa: ANN001
    ...
    def _log_plot(self, fig, trainer):  # noqa: ANN001
...
def _self_similarity(x):  # noqa: ANN001
    y = x.permute(1, 0, 2)
...
class PlotPositionalEncodingSimilarity(Callback):
    def _compute_similarity(self, pl_module):  # noqa: ANN001
    ...
    def _plot_single_similarity(self, sim):  # noqa: ANN001
    ...
    def _plot_multiple_similarities(self, sims):  # noqa: ANN001
        n_pe = len(sims)
    ...
    def _plot_similarity(self, sim):  # noqa: ANN001
...
class PlotLearntProjection(Callback):
    ...
    def _get_assignment(self, pl_module):  # noqa: ANN001
        return pl_module.vector_field.projection.assignment

    def _sort_assignments(self, assignment):  # noqa: ANN001
    ...
    def _plot_assignments(self, pl_module):  # noqa: ANN001
    ...
    def _get_value_similarity(self, pl_module):  # noqa: ANN001
    ...
    def _get_output_similarity(self, pl_module):  # noqa: ANN001
    ...
    def _plot_projections(self, pl_module):  # noqa: ANN001
    ...
    def _log_plots(self, fig_ass, fig_value, trainer):  # noqa: ANN001
    ...
    def _do_plotting(self, trainer, pl_module):  # noqa: ANN001
        if not (
    ...
    def on_train_batch_end(self, trainer, pl_module, outputs, batch, batch_idx):  # noqa: ANN001
...
class PredictionWriter(BasePredictionWriter):
    def __init__(self, output_dir, write_interval):  # noqa: ANN001
    ...
    def write_on_batch_end(
        ...
        batch_indices,  # noqa: ANN001
        batch,  # noqa: ANN001
        batch_idx,  # noqa: ANN001
        dataloader_idx,  # noqa: ANN001
    ):
    ...
    def write_on_epoch_end(self, trainer, pl_module, predictions, batch_indices):  # noqa: ANN001
