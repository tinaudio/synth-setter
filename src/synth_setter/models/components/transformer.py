...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        use_fixed_ast_padding: bool = False,
    ):
        ...
        :param use_fixed_ast_padding: Whether padding follows the matching mel and time axes;
            false preserves legacy checkpoint token geometry.
        """
        super().__init__()
...
class AudioSpectrogramTransformer(nn.Module):
    ...
    def __init__(
        ...
        :param use_fixed_ast_padding: Whether patch padding follows matching axes;
            false preserves legacy checkpoint token geometry.
        """
        super().__init__()
