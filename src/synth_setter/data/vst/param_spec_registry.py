...
from synth_setter.data.vst.synthax_param_spec import SYNTHAX_PARAM_SPEC
from synth_setter.data.vst.torchsynth_param_spec import TORCHSYNTH_PARAM_SPEC
...
param_specs: dict[str, ParamSpec] = {
    ...
    "torchsynth": TORCHSYNTH_PARAM_SPEC,
    "synthax": SYNTHAX_PARAM_SPEC,
}

# "" marks a Python synth backend with no preset file; ``load_preset`` is a no-op there.
