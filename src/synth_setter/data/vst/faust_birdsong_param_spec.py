...
BIRDSONG_PARAMETER_DOMAINS: Mapping[
...
] = MappingProxyType(
    {
        ParamSpecName('faust_syrinx_bird'): (
            ('/syrinx_bird/A_Syllable/1_RA/RA_exc_bias', -8.4, 1.6),
            ('/syrinx_bird/A_Syllable/1_RA/RA_exc_from_HVC_burst', 0.0, 10.0),
            ('/syrinx_bird/A_Syllable/1_RA/RA_exc_self', 1.0, 11.0),
            ('/syrinx_bird/A_Syllable/1_RA/RA_exc_from_RA_inh', -8.0, 2.0),
            ('/syrinx_bird/A_Syllable/1_RA/RA_inh_bias', -12.0, -2.0),
            ('/syrinx_bird/A_Syllable/1_RA/RA_inh_from_HVC_stop_burst', -5.0, 5.0),
            ('/syrinx_bird/A_Syllable/1_RA/RA_inh_from_RA_exc', 1.0, 11.0),
            ('/syrinx_bird/A_Syllable/1_RA/RA_inh_self', -2.0, 8.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_exc_from_RA', 5.0, 15.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_exc_from_IA_pulse', -4.0, 6.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_exc_self', 5.0, 15.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_exc_from_ER_inh', -6.1, 3.9),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_inh_bias', -16.5, -6.5),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_inh_from_RA', -5.0, 5.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_inh_from_ER_exc', 5.0, 15.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_inh_self', -3.0, 7.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/IR_bias', -5.0, 5.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/IR_from_RA', 5.0, 15.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/IR_from_ER_exc', -15.0, -5.0),
            ('/syrinx_bird/A_Syllable/2_Respiratory/ER_exc_bias', -12.45, -2.45),
            ('/syrinx_bird/A_Syllable/3_nXII/vs_bias', -8.0, 2.0),
            ('/syrinx_bird/A_Syllable/3_nXII/vs_from_IA_pulse', -4.0, 6.0),
            ('/syrinx_bird/A_Syllable/3_nXII/vs_from_RA', -4.5, 5.5),
            ('/syrinx_bird/A_Syllable/3_nXII/vs_from_ER', -4.5, 5.5),
            ('/syrinx_bird/A_Syllable/3_nXII/vs_from_IR', -5.0, 5.0),
            ('/syrinx_bird/A_Syllable/3_nXII/vtb_bias', -8.0, 2.0),
            ('/syrinx_bird/A_Syllable/3_nXII/vtb_from_IR', 5.0, 15.0),
            ('/syrinx_bird/A_Syllable/4_Scaling/Pressure_gain', 0.666667, 6.0),
            ('/syrinx_bird/A_Syllable/4_Scaling/Pressure_offset', -2.0, 2.0),
            ('/syrinx_bird/A_Syllable/4_Scaling/Tension_L_gain', 9.66667, 87.0),
            ('/syrinx_bird/A_Syllable/4_Scaling/Tension_L_offset', -10.0, 10.0),
            ('/syrinx_bird/A_Syllable/4_Scaling/Gating_L_vtb_gain', 13.3333, 120.0),
            ('/syrinx_bird/A_Syllable/5_Timing/Syllable_rate', 0.95, 8.55),
            ('/syrinx_bird/A_Syllable/5_Timing/IA_pulse_width', 6.66667, 60.0),
            ('/syrinx_bird/A_Syllable/5_Timing/IA_to_nXII_delay', 3.33333, 30.0),
            ('/syrinx_bird/A_Syllable/5_Timing/IA_to_HVC_to_RA_delay', 10.0, 90.0),
            ('/syrinx_bird/A_Syllable/5_Timing/HVC_burst_width', 10.0, 90.0),
            ('/syrinx_bird/A_Syllable/5_Timing/HVC_stop_burst_delay', 100.0, 900.0),
            ('/syrinx_bird/A_Syllable/5_Timing/HVC_periodic_amount', 0.0, 10.0),
            ('/syrinx_bird/A_Syllable/5_Timing/HVC_periodic_rate', 8.33333, 75.0),
            ('/syrinx_bird/A_Syllable/6_Bilateral/dtb_L_bias', -8.0, 2.0),
            ('/syrinx_bird/A_Syllable/6_Bilateral/dtb_L_from_IA_pulse', 5.0, 15.0),
            ('/syrinx_bird/A_Syllable/6_Bilateral/dtb_L_from_RA', -5.0, 5.0),
            ('/syrinx_bird/A_Syllable/6_Bilateral/Gating_L_dtb_gain', 13.3333, 120.0),
            ('/syrinx_bird/A_Syllable/6_Bilateral/Gating_L_offset', -10.0, 10.0),
            ('/syrinx_bird/B_Mapping/Pressure_scale', 333.333, 3000.0),
            ('/syrinx_bird/B_Mapping/Tension_reference_frequency', 500.0, 4500.0),
            ('/syrinx_bird/B_Mapping/Tension_reference_value', 9.66667, 87.0),
            ('/syrinx_bird/B_Mapping/Gating_to_opening', 0.0333333, 0.3),
            ('/syrinx_bird/mode_2_ratio', 1.0, 5.0),
            ('/syrinx_bird/damping', 10.0, 3000.0),
            ('/syrinx_bird/phonation_rest_opening', -0.5, 1.4),
            ('/syrinx_bird/contact_damping_E', 10.0, 100.0),
            ('/syrinx_bird/tissue_mass_factor', 0.0, 2.0),
            ('/syrinx_bird/gain', 0.0, 1.0),
            ('/syrinx_bird/trachea_length', 5.0, 60.0),
        ),
        ParamSpecName('faust_syrinx2_bird'): (
            ('/syrinx2_bird/0_Air/Air_density', 1.0, 1.4),
            ('/syrinx2_bird/0_Air/Speed_of_sound', 300.0, 380.0),
            ('/syrinx2_bird/1_Anatomy/Bronchus_radius_a', 0.5, 10.0),
            ('/syrinx2_bird/1_Anatomy/Membrane_half-width_h', 0.5, 10.0),
            ('/syrinx2_bird/1_Anatomy/Membrane_thickness_d', 10.0, 500.0),
            ('/syrinx2_bird/1_Anatomy/Membrane_density', 500.0, 1500.0),
            ('/syrinx2_bird/1_Anatomy/Trachea_length_L', 5.0, 120.0),
            ('/syrinx2_bird/1_Anatomy/Mouth_horn_radius_b', 1.0, 20.0),
            ('/syrinx2_bird/1_Anatomy/Bronchial_volume_V', 0.05, 5.0),
            ('/syrinx2_bird/1_Anatomy/Air-sac_impedance_ZG', 0.1, 20.0),
            ('/syrinx2_bird/2_Valve/Coupling_eps_mode_2', 0.0, 1.0),
            ('/syrinx2_bird/2_Valve/Inertance_scale__0_=_quasi-static_', 0.0, 3.0),
            ('/syrinx2_bird/2_Valve/Suction_scale', 0.0, 3.0),
            ('/syrinx2_bird/2_Valve/Mode_2_ratio_f2_f1', 1.0, 4.0),
            ('/syrinx2_bird/2_Valve/Damping_kappa', 10.0, 5000.0),
            ('/syrinx2_bird/2_Valve/Contact_damping_E', 1.0, 100.0),
            ('/syrinx2_bird/2_Valve/Tissue_mass_eta', 0.0, 50.0),
            ('/syrinx2_bird/2_Valve/Phonation_rest_opening_x0', -2.0, 5.0),
            ('/syrinx2_bird/2_Valve/Force_constant_A1', 0.3, 3.0),
            ('/syrinx2_bird/2_Valve/Mass_constant_A3', 0.3, 3.0),
            ('/syrinx2_bird/2_Valve/Coupling_eps_mode_1', 0.0, 1.0),
            ('/syrinx2_bird/3_Tract/Wall_loss_coefficient', 0.0, 10.0),
            ('/syrinx2_bird/3_Tract/Loss_evaluated_at', 100.0, 8000.0),
            ('/syrinx2_bird/3_Tract/Beak_lowpass', 500.0, 20000.0),
            ('/syrinx2_bird/4_Output/Master_gain', -60.0, 0.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_exc_bias', -8.4, 1.6),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_exc_from_HVC_burst', 0.0, 10.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_exc_self', 1.0, 11.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_exc_from_RA_inh', -8.0, 2.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_inh_bias', -12.0, -2.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_inh_from_HVC_stop_burst', -5.0, 5.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_inh_from_RA_exc', 1.0, 11.0),
            ('/syrinx2_bird/A_Syllable/1_RA/RA_inh_self', -2.0, 8.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_exc_from_RA', 5.0, 15.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_exc_from_IA_pulse', -4.0, 6.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_exc_self', 5.0, 15.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_exc_from_ER_inh', -6.1, 3.9),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_inh_bias', -16.5, -6.5),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_inh_from_RA', -5.0, 5.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_inh_from_ER_exc', 5.0, 15.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_inh_self', -3.0, 7.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/IR_bias', -5.0, 5.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/IR_from_RA', 5.0, 15.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/IR_from_ER_exc', -15.0, -5.0),
            ('/syrinx2_bird/A_Syllable/2_Respiratory/ER_exc_bias', -12.45, -2.45),
            ('/syrinx2_bird/A_Syllable/3_nXII/vs_bias', -8.0, 2.0),
            ('/syrinx2_bird/A_Syllable/3_nXII/vs_from_IA_pulse', -4.0, 6.0),
            ('/syrinx2_bird/A_Syllable/3_nXII/vs_from_RA', -4.5, 5.5),
            ('/syrinx2_bird/A_Syllable/3_nXII/vs_from_ER', -4.5, 5.5),
            ('/syrinx2_bird/A_Syllable/3_nXII/vs_from_IR', -5.0, 5.0),
            ('/syrinx2_bird/A_Syllable/3_nXII/vtb_bias', -8.0, 2.0),
            ('/syrinx2_bird/A_Syllable/3_nXII/vtb_from_IR', 5.0, 15.0),
            ('/syrinx2_bird/A_Syllable/4_Scaling/Pressure_gain', 0.666667, 6.0),
            ('/syrinx2_bird/A_Syllable/4_Scaling/Pressure_offset', -2.0, 2.0),
            ('/syrinx2_bird/A_Syllable/4_Scaling/Tension_L_gain', 9.66667, 87.0),
            ('/syrinx2_bird/A_Syllable/4_Scaling/Tension_L_offset', -10.0, 10.0),
            ('/syrinx2_bird/A_Syllable/4_Scaling/Gating_L_vtb_gain', 13.3333, 120.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/Syllable_rate', 0.95, 8.55),
            ('/syrinx2_bird/A_Syllable/5_Timing/IA_pulse_width', 6.66667, 60.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/IA_to_nXII_delay', 3.33333, 30.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/IA_to_HVC_to_RA_delay', 10.0, 90.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/HVC_burst_width', 10.0, 90.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/HVC_stop_burst_delay', 100.0, 900.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/HVC_periodic_amount', 0.0, 10.0),
            ('/syrinx2_bird/A_Syllable/5_Timing/HVC_periodic_rate', 8.33333, 75.0),
            ('/syrinx2_bird/A_Syllable/6_Bilateral/dtb_L_bias', -8.0, 2.0),
            ('/syrinx2_bird/A_Syllable/6_Bilateral/dtb_L_from_IA_pulse', 5.0, 15.0),
            ('/syrinx2_bird/A_Syllable/6_Bilateral/dtb_L_from_RA', -5.0, 5.0),
            ('/syrinx2_bird/A_Syllable/6_Bilateral/Gating_L_dtb_gain', 13.3333, 120.0),
            ('/syrinx2_bird/A_Syllable/6_Bilateral/Gating_L_offset', -10.0, 10.0),
            ('/syrinx2_bird/B_Mapping/Pressure_scale', 333.333, 3000.0),
            ('/syrinx2_bird/B_Mapping/Tension_reference_frequency', 500.0, 4500.0),
            ('/syrinx2_bird/B_Mapping/Tension_reference_value', 9.66667, 87.0),
            ('/syrinx2_bird/B_Mapping/Gating_to_opening', 0.0333333, 0.3),
        ),
        ParamSpecName('faust_tract3_bird'): (
            ('/tract3_bird/0_Air/Air_density', 1.0, 1.4),
            ('/tract3_bird/0_Air/Speed_of_sound', 300.0, 386.0),
            ('/tract3_bird/1_Anatomy_L/Bronchus_radius', 0.833333, 7.5),
            ('/tract3_bird/1_Anatomy_L/Bronchus_length', 4.66667, 42.0),
            ('/tract3_bird/1_Anatomy_L/Membrane_half-width', 0.583333, 5.25),
            ('/tract3_bird/1_Anatomy_L/Lower_bronchus_volume', 0.09, 0.81),
            ('/tract3_bird/1_Anatomy_L/Air-sac_impedance', 0.666667, 6.0),
            ('/tract3_bird/1_Anatomy_L/Membrane_thickness', 33.3333, 300.0),
            ('/tract3_bird/1_Anatomy_L/Membrane_density', 500.0, 2000.0),
            ('/tract3_bird/2_Anatomy_R/Bronchus_radius', 0.833333, 7.5),
            ('/tract3_bird/2_Anatomy_R/Bronchus_length', 4.66667, 42.0),
            ('/tract3_bird/2_Anatomy_R/Membrane_half-width', 0.583333, 5.25),
            ('/tract3_bird/2_Anatomy_R/Lower_bronchus_volume', 0.09, 0.81),
            ('/tract3_bird/2_Anatomy_R/Air-sac_impedance', 0.666667, 6.0),
            ('/tract3_bird/2_Anatomy_R/Membrane_thickness', 33.3333, 300.0),
            ('/tract3_bird/2_Anatomy_R/Membrane_density', 500.0, 2000.0),
            ('/tract3_bird/3_Anatomy_shared/Trachea_length', 7.66667, 69.0),
            ('/tract3_bird/3_Anatomy_shared/Trachea_radius', 1.16667, 10.5),
            ('/tract3_bird/3_Anatomy_shared/Mouth_horn_radius', 3.33333, 30.0),
            ('/tract3_bird/4_Valves/Mass_constant_A3', 0.333333, 3.0),
            ('/tract3_bird/4_Valves/Coupling_eps_mode_1', 0.5, 1.5),
            ('/tract3_bird/4_Valves/Coupling_eps_mode_2', 0.5, 1.5),
            ('/tract3_bird/4_Valves/Inertance_scale', 0.333333, 3.0),
            ('/tract3_bird/4_Valves/Suction_scale', 0.333333, 3.0),
            ('/tract3_bird/4_Valves/Phonation_rest_opening_L', -1.5, 1.5),
            ('/tract3_bird/4_Valves/Phonation_rest_opening_R', -1.5, 1.5),
            ('/tract3_bird/4_Valves/Mode_2_ratio_f2_f1', 1.2, 2.0),
            ('/tract3_bird/4_Valves/Damping_kappa', 523.667, 4713.0),
            ('/tract3_bird/4_Valves/Contact_damping_E', 10.0, 100.0),
            ('/tract3_bird/4_Valves/Tissue_mass_eta', 3.33333, 30.0),
            ('/tract3_bird/4_Valves/Force_constant_A1', 0.333333, 3.0),
            ('/tract3_bird/5_Tract/Wall_loss_coefficient', 0.666667, 6.0),
            ('/tract3_bird/5_Tract/Loss_evaluated_at', 666.667, 6000.0),
            ('/tract3_bird/5_Tract/Beak_lowpass', 2666.67, 24000.0),
            ('/tract3_bird/5_Tract/Beak_reflection', 0.9, 1.0),
            ('/tract3_bird/5_Tract/End_correction_factor', 0.2, 1.8),
            ('/tract3_bird/5_Tract/Junction_loss', 0.0, 0.2),
            ('/tract3_bird/6_Output/Master_gain', -60.0, 0.0),
            ('/tract3_bird/7_Valve_structure/Bernoulli_C_scale', 0.333333, 3.0),
            ('/tract3_bird/7_Valve_structure/Contact_threshold', -0.2, 0.2),
            ('/tract3_bird/7_Valve_structure/Tissue_mass_exponent', 1.0, 3.0),
            ('/tract3_bird/7_Valve_structure/Rest_opening_share_to_mode_2', -1.0, 1.0),
            ('/tract3_bird/7_Valve_structure/Control_smoothing', 1.0, 9.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_exc_bias', -8.4, 1.6),
            ('/tract3_bird/A_Syllable/1_RA/RA_exc_from_HVC_burst', 0.0, 10.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_exc_self', 1.0, 11.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_exc_from_RA_inh', -8.0, 2.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_inh_bias', -12.0, -2.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_inh_from_HVC_stop_burst', -5.0, 5.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_inh_from_RA_exc', 1.0, 11.0),
            ('/tract3_bird/A_Syllable/1_RA/RA_inh_self', -2.0, 8.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_exc_from_RA', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_exc_from_IA_pulse', -4.0, 6.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_exc_self', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_exc_from_ER_inh', -6.1, 3.9),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_inh_bias', -16.5, -6.5),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_inh_from_RA', -5.0, 5.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_inh_from_ER_exc', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_inh_self', -3.0, 7.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/IR_bias', -5.0, 5.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/IR_from_RA', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/IR_from_ER_exc', -15.0, -5.0),
            ('/tract3_bird/A_Syllable/2_Respiratory/ER_exc_bias', -12.45, -2.45),
            ('/tract3_bird/A_Syllable/3_nXII/vs_bias', -8.0, 2.0),
            ('/tract3_bird/A_Syllable/3_nXII/vs_from_IA_pulse', -4.0, 6.0),
            ('/tract3_bird/A_Syllable/3_nXII/vs_from_RA', -4.5, 5.5),
            ('/tract3_bird/A_Syllable/3_nXII/vs_from_ER', -4.5, 5.5),
            ('/tract3_bird/A_Syllable/3_nXII/vs_from_IR', -5.0, 5.0),
            ('/tract3_bird/A_Syllable/3_nXII/vtb_bias', -8.0, 2.0),
            ('/tract3_bird/A_Syllable/3_nXII/vtb_from_IR', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Pressure_gain', 0.666667, 6.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Pressure_offset', -2.0, 2.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Tension_L_gain', 9.66667, 87.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Tension_L_offset', -10.0, 10.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Tension_R_gain', 9.5, 85.5),
            ('/tract3_bird/A_Syllable/4_Scaling/Tension_R_offset', -10.0, 10.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Gating_L_vtb_gain', 13.3333, 120.0),
            ('/tract3_bird/A_Syllable/4_Scaling/Gating_R_vtb_gain', 0.0, 20.0),
            ('/tract3_bird/A_Syllable/5_Timing/Syllable_rate', 0.95, 8.55),
            ('/tract3_bird/A_Syllable/5_Timing/IA_pulse_width', 6.66667, 60.0),
            ('/tract3_bird/A_Syllable/5_Timing/IA_to_nXII_delay', 3.33333, 30.0),
            ('/tract3_bird/A_Syllable/5_Timing/IA_to_HVC_to_RA_delay', 10.0, 90.0),
            ('/tract3_bird/A_Syllable/5_Timing/HVC_burst_width', 10.0, 90.0),
            ('/tract3_bird/A_Syllable/5_Timing/HVC_stop_burst_delay', 100.0, 900.0),
            ('/tract3_bird/A_Syllable/5_Timing/HVC_periodic_amount', 0.0, 10.0),
            ('/tract3_bird/A_Syllable/5_Timing/HVC_periodic_rate', 8.33333, 75.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/dtb_L_bias', -8.0, 2.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/dtb_L_from_IA_pulse', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/dtb_L_from_RA', -5.0, 5.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/dtb_R_bias', -8.0, 2.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/dtb_R_from_IA_pulse', -5.0, 5.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/dtb_R_from_RA', 5.0, 15.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/Gating_L_dtb_gain', 13.3333, 120.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/Gating_L_offset', -10.0, 10.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/Gating_R_dtb_gain', 6.66667, 60.0),
            ('/tract3_bird/A_Syllable/6_Bilateral/Gating_R_offset', -3.0, 17.0),
            ('/tract3_bird/B_Mapping/Pressure_scale', 333.333, 3000.0),
            ('/tract3_bird/B_Mapping/Tension_reference_frequency', 500.0, 4500.0),
            ('/tract3_bird/B_Mapping/Tension_reference_value', 9.66667, 87.0),
            ('/tract3_bird/B_Mapping/Gating_to_opening', 0.0333333, 0.3),
        ),
    }
)
...
_SYRINX_BIRD_SOURCE = r'''// syrinx.dsp — physical model of the avian syrinx
// after Smyth & Smith (DAFx-02, ASA-02) and Smyth, Abel & Smith (SMAC-03).
//
// One syringeal membrane (transverse pressure-controlled valve) feeding a
// digital-waveguide trachea terminated by a lossy open end (beak).
//
// Departures from the papers, made for stability at audio rate:
//  * the flow U is quasi-static (air-column inertance dropped) and solved
//    each sample as a quadratic, implicitly coupled to the bronchial
//    pressure p0 (eq. 1, exact-exponential step) and the tracheal load
//  * each membrane mode uses an *implicit* trapezoid rule (closed form)
//
// Controls: lung pressure (loudness) and membrane tension (pitch) are the
// two primary parameters, as in the SMAC-03 paper.
//
// Verified with libfaust 2.88 (offline render): self-oscillates for roughly
// pG >= 800 Pa at f1 <= 1.5 kHz, needing more pressure as tension rises
// (~3 kPa at 3 kHz); above ~3.5 kHz it does not oscillate with the
// quasi-static flow approximation. Rest opening must be > 0 for onset.
// Period doubling appears at high pressure, as described in SMAC-03.

declare name "syrinx_bird";
declare author "after Smyth & Smith";
import("stdfaust.lib");
...
SR  = fconstant(int fSamplingFreq, <math.h>);
T   = 1.0 / SR;  // sampling period (true rate; library constant clamps at 192 kHz)

// ---------------- anatomy: small bird (SMAC-03, Table 1) ----------------
a    = 1.47e-3;   // bronchus radius [m]
at   = 1.9e-3;    // trachea radius [m]
h    = 1.9e-3;    // membrane width [m]
thk  = 100e-6;    // membrane thickness [m]
rhom = 1000;      // membrane density [kg/m^3]
Lb   = 5e-3;      // bronchus length [m]
Ltr  = hslider("[8]trachea length [unit:mm]", 17.1, 5, 60, 0.1) * 1e-3 : si.smoo;

V  = ma.PI*a*a*Lb;            // bronchus volume
Zb = rho*c/(ma.PI*a*a);       // bronchus characteristic impedance
Z0 = rho*c/(ma.PI*at*at);     // trachea characteristic impedance
ZG = 0.1*Zb;                  // air-sac source impedance (lower = stiffer pressure source)
m1 = rhom*2*a*h*thk;          // effective mass, mode 1
m2 = m1;                      // effective mass, mode 2

// ---------------- controls ----------------
pG    = KP * gP : si.smoo;
f1    = max(200, f1of(gTL)) : si.smoo;
r2    = hslider("[2]mode 2 ratio", 2.7, 1, 5, 0.01);
gam   = hslider("[3]damping", 100, 10, 3000, 1);
x0p   = hslider("[4]phonation rest opening [unit:mm]", 0.5, -0.5, 1.4, 0.01) * 1e-3;
x0    = x0p - KG * 1e-3 * abs(gGL) : si.smoo;
E     = hslider("[5]contact damping E", 30, 10, 100, 1);
alpha = hslider("[6]tissue mass factor", 0.2, 0, 2, 0.01);
gain  = hslider("[7]gain", 0.3, 0, 1, 0.01);

w1 = 2*ma.PI*f1;
w2 = r2*w1;

tau = V*ZG/(rho*c*c);         // bronchus pressure time constant
kp  = 1 - exp(-T/tau);
N   = Ltr/c*SR;               // one-way trachea delay [samples]
B   = 0.98;                   // lumped wall loss per round trip
fcBeak = 6000;                // beak radiation lowpass
xmin = 2e-5;                  // minimum opening used in 1/x terms

// One membrane mode, implicit trapezoid rule for
//   v' = F/m - 2*ge*v - w^2 (x - xr)
...
// One sample of the coupled system.  State: p0, (x,v,a) x 2 modes, pm
step(p0, x1, v1, a1, x2, v2, a2, pm) =
    p0n,
    mode(F, ge, mass(m1), w1, x0, x1, v1, a1),
    mode(F, ge, mass(m2), w2, 0,  x2, v2, a2),
    pmn,
    out
with {
    x  = x1 + x2;              // total membrane displacement (0 = closed)
    op = x > 0;
    xc = max(x, xmin);

    // Bernoulli flow through the slit 2a*x, solved implicitly together with
    // the tracheal load  p1 = Z0*U + 2*pm  (pm = returning wave) and the
    // bronchial pressure update  p0n = (1-kp)*p0 + kp*(pG - ZG*U)  (eq. 1).
    // Substituting gives  kb*U^2 + Zeff*U - dp = 0.
    dp   = (1 - kp)*p0 + kp*pG - 2*pm;
    Zeff = kp*ZG + Z0;
    kb   = rho/(8*a*a*xc*xc);
    U    = op * ma.signum(dp) * (sqrt(Zeff*Zeff + 4*kb*abs(dp)) - Zeff) / (2*kb);

    p1    = Z0*U + 2*pm;       // pressure at base of trachea
    pplus = Z0*U + pm;         // wave launched up the trachea

    // driving force on the membrane, eq. (8): pressure push minus Bernoulli suction
    F  = a*h*(p0 + p1) - op*rho*U*U*h/(7*(a*xc)*sqrt(a*xc));

    ge = gam*(1 + (E - 1)*(x <= 0));                  // eq. (9): extra damping on contact
    mass(m) = m*(1 + alpha*((x - x0)/h)*((x - x0)/h)); // eq. (10): nonlinear mass

    // bronchial pressure, eq. (1): exact exponential step, implicit in U
    p0n = (1 - kp)*p0 + kp*(pG - ZG*U);

    // trachea waveguide: up, reflect at beak (-LPF), back down with wall loss B
    pmn = pplus : de.fdelay(128, 2*N - 1) : fi.lowpass(1, fcBeak) : *(-B);

    // radiated pressure at the beak = incident + reflected
    out = pplus : de.fdelay(128, N) <: _ - fi.lowpass(1, fcBeak);
};

process = (step ~ si.bus(8)) : (si.block(8), _) : *(1e-3*gain);
'''

_SYRINX2_BIRD_SOURCE = r'''// syrinx2.dsp — single-side syringeal valve + trachea, after
...
_TRACT3_BIRD_SOURCE = r'''// tract3.dsp — bilateral avian vocal tract: two Fletcher (1988) syringeal
...
// Valve equations exactly as syrinx2.dsp (Fletcher eq 1-3, 8-11, App. A6).
