"""Production CLI to Lance coverage for the Faust shimmer FDN."""
...
@pytest.mark.slow
def test_faust_shimmer_fdn_generate_cli_writes_consumable_lance_row(
    tmp_path: Path,
) -> None:
    ...
    """
    config = RenderConfig(
        synth=SYNTHS[SynthName("faust_shimmer_fdn")],
    ...
    spec = DatasetSpec(
        task_name="faust-shimmer-fdn-e2e",
