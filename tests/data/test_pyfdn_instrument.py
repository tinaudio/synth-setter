...
from synth_setter.data.pyfdn_param_spec import PYFDN_N8_MONO_HADAMARD_PARAM_SPEC
...
def test_pyfdn_renderer_fixed_hadamard_spec_returns_finite_impulse_response() -> None:
