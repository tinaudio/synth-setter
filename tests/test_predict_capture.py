...
class TestPredictCaptureEndToEnd:
    ...
    def test_audio_dataset_eval_entrypoint_writes_prediction_artifacts(
        self,
        capture_wav: Path,
        ff_checkpoint: Path,
        tmp_path: Path,
        ...
        :param capture_wav: Realistic stereo tone consumed by the audio datamodule.
        :param ff_checkpoint: Real checkpoint of the shipped VST feed-forward module.
        ...
        audio_root.mkdir()
        (audio_root / audio_filename).write_bytes(capture_wav.read_bytes())
        ...
        assert target_audio.shape == (1, 2, 176400)
