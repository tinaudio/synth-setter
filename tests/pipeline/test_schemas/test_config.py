...
class TestLoadDatasetConfig:
    ...
    def test_load_dataset_config_valid_yaml_returns_model(self, write_config_yaml):  # noqa: ANN001
    ...
    def test_load_dataset_config_missing_file_raises_file_not_found(self, tmp_path):  # noqa: ANN001
        """Missing config path raises FileNotFoundError."""
        missing = tmp_path / "nonexistent.yaml"
        with pytest.raises(FileNotFoundError, match="Config file not found"):
            load_dataset_config(missing)

    def test_load_dataset_config_directory_path_raises_file_not_found(self, tmp_path):  # noqa: ANN001
        """Passing a directory (not a file) raises FileNotFoundError, not IsADirectoryError."""
        with pytest.raises(FileNotFoundError, match="Config file not found"):
            load_dataset_config(tmp_path)

    def test_load_dataset_config_empty_yaml_raises_type_error(self, tmp_path):  # noqa: ANN001
    ...
    def test_load_dataset_config_non_mapping_yaml_raises_type_error(self, tmp_path):  # noqa: ANN001
    ...
    def test_load_dataset_config_invalid_yaml_raises(self, tmp_path):  # noqa: ANN001
...
class TestDatasetConfigValidation:
    ...
    def test_dataset_config_splits_must_sum_to_num_shards(self, valid_config_dict):  # noqa: ANN001
    ...
    def test_dataset_config_output_format_defaults_to_hdf5(self, valid_config_dict):  # noqa: ANN001
        """Omitting output_format defaults to hdf5."""
        del valid_config_dict["output_format"]
        cfg = DatasetConfig(**valid_config_dict)
        assert cfg.output_format == "hdf5"

    def test_dataset_config_output_format_rejects_unknown(self, valid_config_dict):  # noqa: ANN001
        """Unknown output_format values are rejected."""
        valid_config_dict["output_format"] = "parquet"
        with pytest.raises(ValidationError):
            DatasetConfig(**valid_config_dict)

    def test_dataset_config_rejects_negative_shard_size(self, valid_config_dict):  # noqa: ANN001
    ...
    def test_dataset_config_rejects_zero_num_shards(self, valid_config_dict):  # noqa: ANN001
    ...
    def test_dataset_config_strict_rejects_extra_fields(self, valid_config_dict):  # noqa: ANN001
        """Extra fields are rejected by the strict model."""
        valid_config_dict["unexpected_field"] = "surprise"
        with pytest.raises(ValidationError):
            DatasetConfig(**valid_config_dict)

    def test_r2_bucket_blank_raises_validation_error(self, valid_config_dict):  # noqa: ANN001
    ...
    def test_dataset_config_velocity_bounds(self, valid_config_dict):  # noqa: ANN001
...
class TestDatasetConfigRoundTrip:
    ...
    def test_dataset_config_round_trip_json(self, valid_config_dict):  # noqa: ANN001
...
class TestConftestFixtureIsolation:
    ...
    def test_valid_config_dict_fixture_isolates_nested_mutations(self, valid_config_dict):  # noqa: ANN001
