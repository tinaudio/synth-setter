...
# hydra.run.dir interpolation. ksin pairs cleanly with ffn (no dataset_root,
# minimal config). logger=[] disables wandb/tensorboard for these throwaway
# subprocess runs. ~callbacks.lr_monitor works around #517 — LearningRateMonitor
# hard-requires a logger and crashes at on_train_start when logger is empty.
overrides = [
    "model=ffn",
    "data=ksin",
    "+run_name=sweep",
