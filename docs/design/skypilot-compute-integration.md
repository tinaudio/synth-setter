...
| Launcher's `_WORKER_ENV_KEYS`          | The keys the worker pod needs (rclone, WANDB, worker-spec/git-ref, partition rank/world)                                        | Defines the forwarding contract. Anything outside this list isn't forwarded.                                                                                                                                                                                                                                                                                                                                                                                                                                   |
