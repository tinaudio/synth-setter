...
| Training        | `train.yml`                    | `workflow_dispatch`                  | `ubuntu-latest`                 | R2, W&B, RunPod     | `experiment` (required), `compute` (expert override)             |
| Evaluation      | `eval.yml`                     | `workflow_dispatch`                  | `ubuntu-latest`                 | R2, W&B, RunPod     | `experiment`, `checkpoint_ref`, `dataset_root_uri`, `compute`    |
