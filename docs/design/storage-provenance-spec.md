...
| Training        | `train.yml`                    | `workflow_dispatch`                  | `ubuntu-latest`                 | R2, W&B, RunPod     | `dataset_root_uri`, `experiment`, `launch_config`                |
