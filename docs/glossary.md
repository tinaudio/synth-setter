...
| Term                  | Definition                                                                                                                                                                                                                                                                                                                                     |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Shard**             | A batch of training samples (audio, mel spectrograms, parameter arrays) in the run's `output_format` — an HDF5 file, a WebDataset tar, or a Lance dataset directory. Typically 1k--10k samples per shard. Named by logical index plus the format suffix (e.g., `shard-000042.h5`, `shard-000042.tar`, or the `shard-000042.lance/` directory). |
