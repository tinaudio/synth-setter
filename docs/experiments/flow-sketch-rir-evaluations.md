...
Each leaf is a suite root; every invocation publishes beneath its automatically generated
attempt UUID, which the W&B `eval-results` artifact references directly.
