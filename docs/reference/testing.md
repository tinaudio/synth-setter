...
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| Hydra-config validation                           | [`tests/test_configs.py`](../../tests/test_configs.py), [`tests/test_generate_dataset.py`](../../tests/test_generate_dataset.py)   | Uses `cfg_train` / `cfg_eval` / `cfg_dataset` fixtures; light assertions + `hydra.utils.instantiate()` / `spec_from_cfg` | (none by default)                                             |
