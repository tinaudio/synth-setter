...
| E2E `from_hydra(cfg_dataset)` shard render → real R2 | `tests/test_generate_dataset_shards.py::test_generate_dataset_renders_shards_to_r2`              | `cfg_dataset`, `monkeypatch`                                                           | `integration_r2`, `r2`, `slow`     |
