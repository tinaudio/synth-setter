...
| Devcontainer + GHA invariants                     | [`tests/infra/`](../../tests/infra) — has its own [`conftest.py`](../../tests/infra/conftest.py)                                                                       | Static checks on `.devcontainer/`, `Dockerfile`, workflow YAML, and Makefile↔Dockerfile plugin-pin parity; opt-in subprocess timing and sandboxed `make` runs               | `infra`                                                       |
