...
| Exhaustive experiment-config composability        | [`tests/test_experiment_configs_compose.py`](../../tests/test_experiment_configs_compose.py)                                                                           | No fixtures; discovers every `experiment/**/*.yaml` on disk and parametrizes over all of them, composing each against the entrypoint it targets. Known-unreachable configs carry a strict `xfail` naming their tracking issue                                                                    | (none)                                                        |
...
| Synth-version pins                                | [`tests/data/vst/test_synth_version_pins.py`](../../tests/data/vst/test_synth_version_pins.py)                                                                         | Mixed gating: unmarked tests assert every synth group composes a non-blank `synth_version`; only the plugin-bundle comparison needs a binary                                                                                                                                                     | `requires_vst` (one test only)                                |
...
| Assert a new experiment config composes                                          | already covered — `tests/test_experiment_configs_compose.py` discovers the file on sight  | —                                                                                      | —                                              |
