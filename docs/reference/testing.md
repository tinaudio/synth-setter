...
| E2E dataset-generation entrypoint                 | [`tests/test_generate_dataset.py`](../../tests/test_generate_dataset.py)                                                           | Uses `cfg_dataset` fixture; drives `from_hydra(cfg_dataset)` or CLI subprocess — e2e only (enforced by `tests/_meta/test_entrypoint_e2e_only.py`)         | `integration_r2`, `r2`, `requires_vst`, `slow`                |
