...
| E2E Pedalboard source → candidate backend probe                                  | `tests/integration/test_backend_parity_smokes_e2e.py`                                     | real R2, linked VST bundles, candidate runtime                                         | `integration_r2`, `r2`, `requires_vst`, `requires_surgepy`, `slow` |
