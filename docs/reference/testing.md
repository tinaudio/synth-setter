...
| E2E `from_hydra(cfg_dataset)` shard render → fake R2 | `tests/test_generate_dataset_shards.py::test_generate_dataset_renders_shards_to_fake_r2`         | `cfg_dataset`, `fake_r2_remote`, `monkeypatch`                                         | `slow`, `requires_vst`             |
