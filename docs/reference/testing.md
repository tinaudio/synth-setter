...
| VST integration tests                             | [`tests/data/vst/test_preset_params.py`](../../tests/data/vst/test_preset_params.py), [`tests/data/vst/test_cardinal_preset.py`](../../tests/data/vst/test_cardinal_preset.py) | Requires the matching VST3 binary; Cardinal validates its committed Rack patch and mapped host controls                                                                                                                                                                                          | `requires_vst`                                                |
| Renderer-version pins                             | [`tests/data/vst/test_renderer_version_pins.py`](../../tests/data/vst/test_renderer_version_pins.py)                                                                           | Mixed gating: unmarked tests assert every render group composes a non-blank `renderer_version`; only the plugin-bundle comparison needs a binary                                                                                                                                                 | `requires_vst` (one test only)                                |
