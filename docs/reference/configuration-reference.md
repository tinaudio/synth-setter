...
| Input                                               | Type                 | What's Needed                                                                                                             | Reference                                                                                                                                 |
| --------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| RunPod config                                       | Hydra compute option | Compute options live under `src/synth_setter/configs/skypilot_launch/compute/runpod/`; the reference link enumerates them | [SkyPilot compute integration](../design/skypilot-compute-integration.md#41-compute-options-srcsynth_setterconfigsskypilot_launchcompute) |
