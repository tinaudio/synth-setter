...
| Workflow                    | Purpose                                                                                                                                                                                                                                                                                                                                                                                 | Gotcha                                                                                                                                                                                                                 |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `generate-dataset-shards`   | Reusable workflow: invokes `pipeline.entrypoints.skypilot_launch` for one provider (skypilot-local kind / runpod / oci) and uploads the run-metadata artifact. Consumed by `test-dataset-generation`.                                                                                                                                                                                   | Mounts PR code as a volume into the container for runpod/oci rows. See [Mount-as-volume pattern](#mount-as-volume-pattern).                                                                                            |
| `validate-dataset-shards`   | Reusable workflow: structural spec validation (`pipeline.ci.validate_spec`) + per-shard HDF5 validation (`pipeline.ci.validate_shard`) against shards downloaded from R2. Consumes the run-metadata artifact uploaded by `generate-dataset-shards`.                                                                                                                                     |                                                                                                                                                                                                                        |
