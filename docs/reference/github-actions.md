...
| `RCLONE_CONFIG_R2_ACCESS_KEY_ID`          | `dataset-generation`, `spec-materialization`, `test-dataset-generation`, `test-skypilot-debug`, `test-skypilot-local`, `check-auth` | Cloudflare R2 credentials passed as runtime env vars to `docker run` (rclone reads `RCLONE_CONFIG_R2_*` directly).                                                                                                                                                                                                                                                      |
| `RCLONE_CONFIG_R2_SECRET_ACCESS_KEY`      | same as above                                                                                                                       | Paired with `RCLONE_CONFIG_R2_ACCESS_KEY_ID`.                                                                                                                                                                                                                                                                                                                           |
| `RCLONE_CONFIG_R2_ENDPOINT`               | `dataset-generation`, `spec-materialization`, `test-dataset-generation`, `test-skypilot-debug`, `test-skypilot-local`, `check-auth` | R2 endpoint URL (runtime).                                                                                                                                                                                                                                                                                                                                              |
