...
foreground host clears the ownership handles from unfinished rows before this
session starts; otherwise an incomplete known owner fails closed. Never repeat a
