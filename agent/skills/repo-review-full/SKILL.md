...
when you want a dry-run of the review without posting GitHub review comments,
as a pre-PR gate after pushing the branch's current HEAD, or when you're
iterating on a PR before it's ready for reviewers.
